-- Enhanced RPC for staff activity dashboard with richer fields
...
RETURNS TABLE(
  ...
  shortage_reports_today integer
)
LANGUAGE plpgsql
...
BEGIN
  ...
  SELECT
    ...
    EXISTS (
      ...
      WHERE rd.staff_user_id = a.user_id AND rd.report_date = _target_date
