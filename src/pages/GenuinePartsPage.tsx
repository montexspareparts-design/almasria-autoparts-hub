...
const categories = [
  { icon: Filter, title: "فلاتر", desc: "زيت — هواء — وقود — تكييف" },
  { icon: ShieldCheck, title: "تيل فرامل", desc: "تيل أصلي لجميع الموديلات" },
  { icon: Wrench, title: "مساعدات وتعليق", desc: "مساعدات وكاوتش وقطع تعليق" },
  { icon: Cog, title: "أجزاء المحرك", desc: "طلمبات مياه، سيور، حوامل" },
  { icon: Package, title: "كهرباء وحساسات", desc: "بوجيهات، حساسات أوكسجين وحرارة" },
  { icon: Truck, title: "سيور ونواقل", desc: "سيور كاتينة وتكييف وديناموا" },
];
        ...
        <div className="relative z-10 container mx-auto px-4 py-24 text-center max-w-[760px]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button size="lg" className="font-bold gap-2" asChild>
              <Link to="/contact#quote" aria-label="اطلب عرض سعر لقطع غيار تويوتا الأصلية">
                اطلب عرض سعر
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="font-bold gap-2 border-white/20 text-white bg-white/5 hover:bg-white/10" asChild>
              <Link to="#categories" aria-label="تصفح فئات قطع الغيار الأصلية">
                تصفح الفئات
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {models.map((m) => (
              <span
                key={m}
                className="px-5 py-2.5 bg-card border border-border rounded-full text-sm font-bold text-foreground"
              >
                {m}
              </span>
            ))}
          ...
          <p className="text-muted-foreground text-center text-sm">
            نوفر دعمًا لموديلات إضافية حسب الطلب —{" "}
            <Link to="/contact" className="text-primary font-bold hover:underline">تواصل معنا</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-secondary text-secondary-foreground">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            ...
            <Link to="/why-us" className="text-secondary-foreground/60 hover:text-primary transition-colors">ما يميزنا</Link>
          </div>
        </div>
      </section>
