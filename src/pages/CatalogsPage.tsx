...
const CatalogsPage = () => {
  ...
  // Unique categories from fetched catalogs
        ...
        <main className="min-h-screen bg-background flex items-center justify-center px-4 py-20">
          ...
          >
            ...
            <h1 className="text-2xl font-bold text-foreground mb-3">
              محتوى حصري لتجار الجملة
            </h1>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              الكتالوجات التفصيلية متاحة فقط لتجار الجملة المعتمدين (درجة أولى أو ثانية).
              يمكنك التقديم للحصول على عضوية تاجر الجملة.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button asChild size="lg">
                <Link to="/dealer-apply">التقديم كتاجر جملة</Link>
              </Button>
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center" dir="rtl">
          ...
          >
            ...
            <p className="text-lg text-white/60 max-w-xl mx-auto">
              تصفّح وحمّل الكتالوجات التفصيلية لجميع الماركات والفئات
            </p>
          </motion.div>
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-start gap-3 mb-4">
                        <div
                          className={`w-12 h-14 rounded-xl flex items-center justify-center flex-shrink-0 transition-all ${colors.bg} group-hover:scale-105`}
                        >
                      ...
                      {/* Category badge */}
                      <span
                        className={`inline-block text-xs px-2.5 py-1 rounded-full border font-medium mb-4 ${colors.bg} ${colors.text} ${colors.border}`}
                      >
                      ...
                      <Button
                        ...
                        variant={catalog.file_url ? "default" : "outline"}
                      >
