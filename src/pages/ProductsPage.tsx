    ...
    return (
      <div className="min-h-screen bg-dark-section">
        <SEOHead
          ...
          descriptionAr="تصفح كتالوج المصرية جروب: قطع غيار تويوتا الأصلية، زيوت تويوتا، MTX Aftermarket، DENSO، وAISIN. أكثر من 12 ألف صنف متاح."
          descriptionEn="Browse Al Masria Group catalog: Toyota genuine parts, oils, MTX Aftermarket, DENSO, and AISIN — 12K+ items in stock."
