          ...
          <motion.div className="lg:col-span-7 order-1" initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}>
            <div className="space-y-8 mb-10">
              {isAr ? (
                <>
                  {[
                    <>تعمل المصرية جروب منذ <strong className="text-primary font-black">1999</strong> كموزّع معتمد لِـ <Link to="/products/toyota-genuine" className="text-primary font-black hover:underline underline-offset-4 decoration-2 decoration-primary/50">قطع غيار تويوتا الأصلية</Link> و<Link to="/products/toyota-oils" className="text-primary font-black hover:underline underline-offset-4 decoration-2 decoration-primary/50">زيوت تويوتا</Link>. نعتمد نموذج تشغيل منضبط قائم على <strong className="text-secondary-foreground font-bold">أنظمة إدارة رقمية متكاملة</strong> و<strong className="text-secondary-foreground font-bold">شبكة توزيع</strong> تغطي الجمهورية.</>,
                    <>نوفر <strong className="text-secondary-foreground font-bold">توصيلًا سريعًا</strong> خلال <strong className="text-primary font-black">48&nbsp;ساعة</strong> عبر مخازن مركزية عالية الكفاءة، مع <strong className="text-secondary-foreground font-bold">وجود إقليمي</strong> <strong className="text-primary font-black">في دبي</strong> يدعم استمرارية التوريد وجودة المنتجات.</>,
                    <>كما ندير علامة <Link to="/mtx" className="text-primary font-black hover:underline underline-offset-4 decoration-2 decoration-primary/50">MTX</Link> لقطع الغيار البديلة بجودة تضاهي المواصفات الأصلية.</>,
                  ].map((text, i) => (
