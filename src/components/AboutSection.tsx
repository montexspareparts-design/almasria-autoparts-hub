...
const sections = [
  ...
  },
  {
    ...
    title: "نطاق العمليات",
    content:
      "تدير المجموعة شبكة توزيع منظّمة تضم 4 فروع رئيسية: القاهرة (التوفيقية)، الجيزة (أوسيم)، الأقصر، ومكتب دبي كمركز إقليمي للتوسع في أسواق الخليج. تخدم هذه الشبكة أكثر من 1,000 عميل نشط في جميع محافظات مصر، مع التزام بالتسليم خلال 48 ساعة مدعومًا بنظام ERP متكامل لإدارة المخزون وسلسلة الإمداد.",
  },
  {
    icon: Lightbulb,
    title: "فلسفة العمل",
