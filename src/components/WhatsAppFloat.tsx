...
const WhatsAppFloat = () => {
  ...
  return (
    <div className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-50">
      <motion.a
        href={`https://wa.me/201153961008?text=${encodeURIComponent(defaultMsg)}`}
        target="_blank"
        rel="noopener noreferrer"
        onClick={handleClick}
        className="flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe57] text-white rounded-full shadow-[0_4px_15px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_25px_rgba(37,211,102,0.6)] transition-shadow group"
