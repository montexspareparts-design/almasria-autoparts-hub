...
REVOKE ALL ON FUNCTION public.apply_oils_coupon(uuid, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.apply_oils_coupon(uuid, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.apply_oils_coupon(uuid, text) TO service_role;